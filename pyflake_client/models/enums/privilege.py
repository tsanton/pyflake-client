...
class Privilege(str, Enum):
    ...
    CREATE_SF_ML_ANOMALY_DETECTION = "CREATE SNOWFLAKE.ML.ANOMALY_DETECTION"
    CREATE_SF_ML_FORECAST = "CREATE SNOWFLAKE.ML.FORECAST"
    CREATE_SF_CORE_BUDGET = "CREATE SNOWFLAKE.CORE.BUDGET"
