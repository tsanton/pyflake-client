...
from pyflake_client.models.describables.grants.role_grant import (
    RoleGrant as RoleGrantDescribable,
)
from pyflake_client.models.describables.grant import Grant as DescribableGrant
from pyflake_client.models.entities.grants.role_grant import (
    RoleGrant as RoleGrantEntity,
)
...
def test_grant_role_account_privilege(
    ...
    try:
        ...
        ### Act ###
        grants = flake.describe_many(DescribableGrant(role), RoleGrantEntity)
...
def test_grant_role_account_privileges(
    ...
    try:
        ...
        ### Act ###
        granted: RoleGrantsEntity = flake.describe(
            RoleGrantDescribable(role.name), RoleGrantsEntity
        )
